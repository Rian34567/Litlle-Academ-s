document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contatoForm) {
        const formspreeURLContato = 'https://formspree.io/f/xjkvyngj'; // URL para o Formspree de contato
    ...
    if (orcamentoForm) {
        const formspreeURLorcamento = 'https://formspree.io/f/mldejqnv'; // URL para o Formspree de orçamento
